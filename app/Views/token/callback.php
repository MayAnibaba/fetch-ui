                            ...
                            <!-- <div class="col-lg-6"> -->
                                <div class="p-5">
                                    <div class="text-center">
                                        ...
                                        <!-- <h1 class="h4 text-gray-900 mb-4">Welcome Back!</h1> -->
                                        <?php if($success){?>
                                        <p><a href="#" class="btn btn-success btn-circle btn-lg"><i class="fas fa-check"></i></a><br/> You have successfully added a repayment instrument</P><br/>
                                        <?php } else { ?>
                                        <p><a href="#" class="btn btn-warning btn-circle btn-lg"><i class="fas fa-check"></i></a><br/> Something went wrong, please try again</P><br/>
                                        <?php } ?>
                                    </div>
                                    <!-- <?php # if(!$success){?>
